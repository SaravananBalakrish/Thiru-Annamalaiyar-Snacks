...
import 'package:e_shop_api/src/api_util.dart';
...
class OrdersApi {
  ...
  Future<Response<BuiltList<Order>>> v1OrdersGet({ 
    int? userId,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> v1OrdersIdGet({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/orders/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> v1OrdersIdPayPost({ 
    required int id,
    required PayOrderInput payOrderInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/orders/{id}/pay'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PayOrderInput);
      _bodyData = _serializers.serialize(payOrderInput, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> v1OrdersPost({ 
    ...
    try {
      const _type = FullType(OrderInput);
      _bodyData = _serializers.serialize(orderInput, specifiedType: _type);
